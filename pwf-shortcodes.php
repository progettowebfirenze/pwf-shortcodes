...
function pwf_shortcodes_scripts() {
	...
	wp_enqueue_script('pwf-formvalidationjs', $vendors_path . '/formvalidation/dist/js/formValidation.min.js', array(JQUERY_NAME), 1.0, true);
	wp_enqueue_script('pwf-formvalidation-framework', $vendors_path . '/formvalidation/dist/js/framework/bootstrap.min.js', array(JQUERY_NAME), 1.0, true);
	wp_enqueue_script('pwf-i18n', $vendors_path . '/formvalidation/dist/js/addon/i18n.min.js', array(JQUERY_NAME), 1.0, true);
	wp_enqueue_script('pwf-validIT', $vendors_path . '/formvalidation/dist/js/language/it_IT.js', array(JQUERY_NAME), 1.0, true);
	wp_enqueue_script('pwf-magnific-popupjs', $vendors_path . '/magnific-popup/dist/jquery.magnific-popup.min.js', array(JQUERY_NAME), 1.0, true);
	wp_enqueue_script('pwf-datedropper-js', $vendors_path . '/datedropper/datedropper.js', array(JQUERY_NAME), 1.0, true);
}
